      ...
      <div className="flex flex-col gap-4 text-white p-4">
        ...
        {!customerNumber && (
          <div className="w-full flex justify-center">
            <div className="bg-primary border border-emerald-500 p-2 rounded-md text-emerald-500 text-lg font-bold w-fit">
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className=" flex flex-col gap-4 mb-4 sm:flex-row w-full">
            <input
              type="text"
        ...
        <>
          <div className="flex flex-col md:flex md:flex-row md:justify-center gap-4 w-full">
